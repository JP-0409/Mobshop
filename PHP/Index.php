...
<body>
     ...
     <div class="Main">
          ...
          <div class="w3-content w3-section" style="max-width:500px">
               <img class="mySlides" src="./Picture/apple.jpg" style="width:100%">
               <img class="mySlides" src="./Picture/oppo.png" style="width:100%">
               <img class="mySlides" src="./Picture/redmi.png" style="width:100%">
             </div>
